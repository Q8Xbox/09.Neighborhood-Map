...
class InfoTab extends Component {
  ...
  componentDidMount() {
    fetch(`https://api.foursquare.com/v2/venues/search?ll=33.888928,-118.393534&client_id=${FOURSQUARE_CLIENT_ID}&client_secret=${FOURSQUARE_CLIENT_SECRET}&v=20181102&near&query=${this.props.currentPlace}&limit=1`)
    .then((res) => res.text())
    .then((text) => {
    ...
    .then((id) => {
      fetch(`https://api.foursquare.com/v2/venues/${id}/photos?client_id=${FOURSQUARE_CLIENT_ID}&client_secret=${FOURSQUARE_CLIENT_SECRET}&v=20181102`)
      .then((res) => res.text())
      .then((text) => {
    ...
    .then((id) => {
      fetch(`https://api.foursquare.com/v2/venues/${id}?client_id=${FOURSQUARE_CLIENT_ID}&client_secret=${FOURSQUARE_CLIENT_SECRET}&v=20181102`)
      .then((res) => res.text())
      .then((text) => {
